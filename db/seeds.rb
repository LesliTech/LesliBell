...
if Rails.env.development? 
    ...
    L2.msg("Loading seeds for CloudBell environment", "Version: #{CloudBell::VERSION}", "Build: #{CloudBell::BUILD}")

    load CloudBell::Engine.root.join("db", "seed", "#{ Rails.env.downcase }.rb")
end 
