...
module CloudBell
    class NotificationService
        ...
        def self.generate(
            ...
            # "bulk insert" all the notifications, perform in a job so that the response doesn't takes too much
            CloudBell::SendNotificationsJob.perform_later(user, notifications)
