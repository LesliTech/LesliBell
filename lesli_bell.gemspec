...
Gem::Specification.new do |spec|
    ...
    spec.summary     = "Notifications & Announcements System for the Lesli Framework."
    spec.description = "Notifications & Announcements System for the Lesli Framework."
    ...
    spec.add_dependency("lesli", "~> 5.0.0")
